...
public class servicesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.findViewById(R.id.services_toolbar_back_button).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        cityName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(servicesActivity.this, locationActivity.class));
            }
        });
        ...
        storesList = findViewById(R.id.services_options_recycler_view);
        recyclerViewLayout = new GridLayoutManager(servicesActivity.this, 3);
        ...
        storesList.addOnItemTouchListener(new RecyclerItemClickListener(this, storesList, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent innerStoreIntent = new Intent(servicesActivity.this, servicesInnerActivity.class);
        ...
        shoppingManager = new LinearLayoutManager(servicesActivity.this);
        ...
        viewPager.addOnItemTouchListener(new RecyclerItemClickListener(this, viewPager, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent posterDetails = new Intent(servicesActivity.this, PosterDetailsActivity.class);
    ...
    private void loadPosters() {
        StringRequest posterRequest = new StringRequest(Request.Method.POST, Constants.baseURL + Constants.getPosterURL,
            ...
            protected Map<String, String> getParams() {
                ...
                posterType.put("poster_type", "service");
    ...
    private void loadStoreCategories() {
        StringRequest storeCategory = new StringRequest(Constants.baseURL + Constants.getServices,
                new Response.Listener<String>() {

                    @Override
                    public void onResponse(String response) {
                        try {
                            Log.i("service result", response);
    ...
    private void loadStoresAdapter(String data) throws JSONException {
        ...
        for(int i=0; i<dataArray.length(); i++) {
            JSONObject services = dataArray.getJSONObject(i);
            storeIcons.add(services.getString("service_category_image"));
            storeNames.add(services.getString("service_category_name"));
        }
        loadServices = new servicesAdapter(storeNames, storeIcons, this);
        storesList.setAdapter(loadServices);
    }
    ...
    protected void onStart() {
        ...
        if (viewPager.getAdapter() != null) {
            ...
            PosterTimer.schedule(new servicesActivity.PosterTimeChecker(PosterCount), 0, 3500);
        }
    }
